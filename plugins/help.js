...
var hsimsg =''
if(config.LANG === 'SI') hsimsg = 'DARK DEV MINI උපකාර මධ්‍යස්ථානය විවෘත්ත කරන්න'
else hsimsg = "Open DARK DEV MINI Help Center"
...
cmd({
  ...
  try {
      ...
      "https://raw.githubusercontent.com/skyhost546-prog/DATA/refs/heads/main/DARK DEV MINI.json"
    )).data;
    ...
    const caption = `_👋 Welcome to DARK DEV MINI MD Help Center!_ 💬
...
cmd({
  ...
  try {
    ...
    const ownerdata = (await axios.get(
      "https://raw.githubusercontent.com/skyhost546-prog/DATA/refs/heads/main/shinigami.json"
    )).data;
    ...
    const step1 = `👋 DARK DEV MINI Help Center වෙත සාදරයෙන් පිළිගනිමු! 💬

🚩 DARK DEV MINI Beta Help 🚩
...
cmd({
  ...
  try {
    ...
    const step1 = `👋 Welcome to the DARK DEV MINI Help Center! 💬
...
🚩 [  DARK DEV MINI Beta Bot - නිතර අසන ප්‍රශ්න ] 🚩

*➤ 1️⃣ DARK DEV MINI Beta Bot යනු කුමක්ද?*
DARK DEV MINI Beta BOT යනු කෙනෙක් වන නෙත්මික විසින් නිර්මාණය WhatsApp බොට් එකකි.
...
🚩 [ DARK DEV MINI Beta Bot – Frequently Asked Questions ] 🚩

*➤ 1️⃣ What is DARK DEV MINI Beta Bot?*
DARK DEV MINI Beta Bot is a WhatsApp bot created by a developer named Nethmika.
